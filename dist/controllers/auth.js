...
exports.Admins = exports.update_user = exports.delete_User = exports.updatePassword = exports.ReceivedOtp = exports.forgetPassowrd = exports.AllUsers = exports.Logout = exports.Login = exports.Signup = void 0;
...
const delete_User = async (req, res) => {
    ...
    try {
        let result = await db.deleteOne({ _id: new mongodb_2.ObjectId(param) });
...
const update_user = async (req, res) => {
    ...
    try {
        let result = await db.updateOne({ _id: new mongodb_2.ObjectId(param) }, { $set: { isAdmin: statusInbolean } });
        res.send(result);
    }
    catch (e) {
