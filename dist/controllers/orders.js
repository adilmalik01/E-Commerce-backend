...
exports.EditProfile = exports.Profile = exports.DeleteOrder = exports.AdminOrderDetail = exports.SingalOrder = exports.AllOrders = exports.AddOrders = void 0;
...
const AdminOrderDetail = async (req, res) => {
    let param = req.params.id;
    try {
        const response = await db.find({ _id: new mongodb_2.ObjectId(param) }, {});
        let cursor = await response.toArray();
        res.send(cursor);
    }
    catch (e) {
